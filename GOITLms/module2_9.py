# На собеседованиях часто любят спрашивать про алгоритмы.
# Например, рассчитайте наибольший общий делитель (НОД) двух положительных чисел.
...
# а наш цикл должен закончиться, только если gcd разделил оба числа без остатка.
...
print(f"Наибольший общий делитель чисел {first} и {second}: {gcd}")